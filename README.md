...
Cansado de pensar em mensagens de commit? **Commit-AI** é a sua ferramenta definitiva para automatizar e aprimorar seu fluxo de trabalho no Git. Utilizando o poder de modelos de linguagem (LLMs), ela transforma suas alterações de código em mensagens de commit e descrições de Pull Request claras, contextuais e profissionais.
...
4.  **✍️ Gere o Commit**: Volte ao Commit-AI, selecione os arquivos alterados e clique para que a IA analise as `diffs` e gere uma mensagem de commit inteligente.
...
O Commit-AI é compatível com uma variedade de provedores de LLM. Basta ter sua chave de API em mãos.
